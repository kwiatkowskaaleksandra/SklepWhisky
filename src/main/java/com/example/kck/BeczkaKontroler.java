...
public class BeczkaKontroler implements Initializable {
                    ...
                    private final Button btn = new Button("Dodaj do koszyka");
                    {
                        btn.setOnAction((ActionEvent event) -> {
                            ...
                            try {
                                ...
                                stat = connectDB.createStatement();
                                float cena = 0;
                                String cn = "SELECT cena FROM produkty p WHERE idProduktu='" + ideProdB + "'";
                                ...
                                try {
                                    ...
                                    pst.setString(2, String.valueOf(ideProdB));
